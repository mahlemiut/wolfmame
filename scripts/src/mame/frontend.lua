...
files {
	...
	MAME_DIR .. "src/frontend/mame/inpview.cpp",
	MAME_DIR .. "src/frontend/mame/inpview.h",
	...
	MAME_DIR .. "src/frontend/mame/ui/recinp.cpp",
	MAME_DIR .. "src/frontend/mame/ui/recinp.h",
