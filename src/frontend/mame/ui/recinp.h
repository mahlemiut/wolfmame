...
{
public:
	ui_menu_record_inp(mame_ui_manager &mui, render_target &target, const game_driver *driver = nullptr);
...
{
public:
	ui_menu_playback_inp(mame_ui_manager &mui, render_target &target, const game_driver *driver = nullptr);
