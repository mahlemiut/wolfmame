...
--   wolf.lua
--
--   WolfMAME target makefile
--   Excludes (hopefully) all mechanical drivers (fruit machine/pinball)
--
---------------------------------------------------------------------------
...
-- exclude bfm, barcrest, jpm, maygay and pinball, also proconn.c from misc
function linkProjects_mame_wolf(_target, _subtarget)
	links {
		"acorn",
		"alba",
		"alliedl",
...
function createProjects_mame_wolf(_target, _subtarget)
--------------------------------------------------
